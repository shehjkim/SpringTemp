...
public class KakaoAPI {
	...
	public String getAccessToken (String authorize_code) {
        ...
        try {
            ...
            sb.append("grant_type=authorization_code");					//카카오 REST API 키
            sb.append("&client_id=0333a5381d562d3bb9ae06134c014141");	//카카오 REDIRECT URL
            sb.append("&redirect_uri=http://localhost/bank/callback");
